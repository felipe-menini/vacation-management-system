...
public sealed record BalanceMutationAuditContext(Guid ActorUserId, string Action);
...
public interface IBalanceRepository
{
    ...
    Task<BalanceMutationRecord> MutateAsync(Guid userId, Guid balanceBucketId, Guid operationId, BalanceLedgerEntryType type, decimal amount, string reason, Guid? createdByUserId, DateTime createdAtUtc, BalanceMutationAuditContext? auditContext, CancellationToken cancellationToken);
}

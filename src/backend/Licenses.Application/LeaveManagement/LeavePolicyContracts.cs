...
public sealed record LeavePolicyVersionDto(Guid Id, Guid LeavePolicyId, int VersionNumber, string Status, DateOnly EffectiveFrom, DateOnly? EffectiveTo, string DayCountMode, bool AllowHalfDay, int? MinimumNoticeDays, string NoticeDayCountMode, decimal? MaximumRequestDays, string? RequiredDocumentKind, string OverlapBehavior, bool ConsumesBalance, Guid? BalanceBucketId, string? BalanceBucketCode, string? BalanceBucketName, Guid? WorkingCalendarId, string? WorkingCalendarCode, string? WorkingCalendarName, DateTime CreatedAtUtc, DateTime UpdatedAtUtc, DateTime? PublishedAtUtc);
public sealed record CreateLeavePolicyVersionCommand(DateOnly EffectiveFrom, DateOnly? EffectiveTo, string DayCountMode, bool AllowHalfDay, int? MinimumNoticeDays, string NoticeDayCountMode, decimal? MaximumRequestDays, string OverlapBehavior, bool ConsumesBalance, Guid? BalanceBucketId, Guid? WorkingCalendarId, string? RequiredDocumentKind = null);
public sealed record UpdateLeavePolicyVersionCommand(DateOnly EffectiveFrom, DateOnly? EffectiveTo, string DayCountMode, bool AllowHalfDay, int? MinimumNoticeDays, string NoticeDayCountMode, decimal? MaximumRequestDays, string OverlapBehavior, bool ConsumesBalance, Guid? BalanceBucketId, Guid? WorkingCalendarId, string? RequiredDocumentKind = null);

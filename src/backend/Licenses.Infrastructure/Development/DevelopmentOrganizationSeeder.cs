...
public static class DevelopmentOrganizationSeeder
{
    ...
    private static async Task<Dictionary<string, Permission>> EnsurePermissionCatalogAsync(ApplicationDbContext db, CancellationToken cancellationToken)
    {
        var catalog = new Dictionary<string, string>
        {
            ...
            [PermissionCodes.LeaveCalendarRead] = "Read team leave calendar entries inside authorized organizational scope.",
            [PermissionCodes.LeaveReportsRead] = "Read aggregate leave reports inside authorized organizational scope.",
            [PermissionCodes.LeaveDocumentsReadSelf] = "Read documents attached to own leave requests.",
            [PermissionCodes.LeaveDocumentsUploadSelf] = "Upload documents to own leave requests.",
            [PermissionCodes.LeaveDocumentsRead] = "Read leave request documents inside authorized organizational scope.",
            [PermissionCodes.AuditEventsRead] = "Read audit events inside authorized organizational scope.",
            [PermissionCodes.AuthorizationRoleScopesManage] = "Manage user role scope assignments inside authorized organizational scope."
        };

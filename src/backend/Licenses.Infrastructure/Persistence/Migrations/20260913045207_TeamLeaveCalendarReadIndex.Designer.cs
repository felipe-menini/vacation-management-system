...
namespace Licenses.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260913045207_TeamLeaveCalendarReadIndex")]
    partial class TeamLeaveCalendarReadIndex
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Licenses.Domain.LeaveManagement.LeavePolicyVersion", b =>
                {
                    ...
                    b.Property<string>("RequiredDocumentKind")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)")
                        .HasColumnName("required_document_kind");
            ...
            modelBuilder.Entity("Licenses.Domain.LeaveManagement.LeaveRequest", b =>
                {
                    ...
                    b.HasIndex("OrgUnitId", "Status", "StartDate", "EndDate");
